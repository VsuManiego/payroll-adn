...
lblCity = Label(InsideLFL, font=('arial', 12, 'bold'), text="City Weighting", fg="Forest green", bd=10, anchor="w")
lblCity.grid(row=0, column=0)
txtCity = Entry(InsideLFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="yellow green", justify="right", textvariable = City)
txtCity.grid(row=0, column=1)

lblBasic = Label(InsideLFL, font=('arial', 12, 'bold'), text="Basic Salary", fg="Forest green", bd=10, anchor="w")
lblBasic.grid(row=1, column=0)
txtBasic = Entry(InsideLFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="yellow green", justify="right", textvariable = Basic)
txtBasic.grid(row=1, column=1)

lblOverTime = Label(InsideLFL, font=('arial', 12, 'bold'), text="Over Time", fg="Forest green", bd=10, anchor="w")
lblOverTime.grid(row=2, column=0)
txtOverTime = Entry(InsideLFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="yellow green", justify="right", textvariable = OverTime)
txtOverTime.grid(row=2, column=1)

lblGrossPay = Label(InsideLFL, font=('arial', 12, 'bold'), text="Gross Pay", fg="Forest green", bd=10, anchor="w")
lblGrossPay.grid(row=3, column=0)
lblGrossPay = Entry(InsideLFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="yellow green", justify="right", textvariable = GrossPay)
lblGrossPay.grid(row=3, column=1)

lblNetPay = Label(InsideLFL, font=('arial', 12, 'bold'), text="Net Pay", fg="Forest green", bd=10, anchor="w")
lblNetPay.grid(row=4, column=0)
lblNetPay = Entry(InsideLFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="yellow green", justify="right", textvariable = NetPay)
lblNetPay.grid(row=4, column=1)

#-------------------Left Right Side
lblTax = Label(InsideLFR, font=('arial', 12, 'bold'), text="Tax", fg="Forest green", bd=10, anchor="w")
lblTax.grid(row=0, column=0)
txtTax = Entry(InsideLFR, font=('arial', 12, 'bold'), bd=10, width=18, bg="yellow green", justify="right", textvariable = Tax)
txtTax.grid(row=0, column=1)

lblPension = Label(InsideLFR, font=('arial', 12, 'bold'), text="Pension", fg="Forest green", bd=10, anchor="w")
lblPension.grid(row=1, column=0)
txtPension = Entry(InsideLFR, font=('arial', 12, 'bold'), bd=10, width=18, bg="yellow green", justify="right", textvariable = Pension)
txtPension.grid(row=1, column=1)

lblStudenLoan = Label(InsideLFR, font=('arial', 12, 'bold'), text="StudenLoan", fg="Forest green", bd=10, anchor="w")
lblStudenLoan.grid(row=2, column=0)
txtStudenLoan = Entry(InsideLFR, font=('arial', 12, 'bold'), bd=10, width=18, bg="yellow green", justify="right", textvariable = StudenLoan)
txtStudenLoan.grid(row=2, column=1)

lblNIPavment = Label(InsideLFR, font=('arial', 12, 'bold'), text="NI Pavment", fg="Forest green", bd=10, anchor="w")
lblNIPavment.grid(row=3, column=0)
txtNIPavment = Entry(InsideLFR, font=('arial', 12, 'bold'), bd=10, width=18, bg="yellow green", justify="right", textvariable = NIPayment)
txtNIPavment.grid(row=3, column=1)

lblDeducations = Label(InsideLFR, font=('arial', 12, 'bold'), text="Deducations", fg="Forest green", bd=10, anchor="w")
lblDeducations.grid(row=4, column=0)
txtDeducations = Entry(InsideLFR, font=('arial', 12, 'bold'), bd=10, width=18, bg="yellow green", justify="right", textvariable = Deducations)
txtDeducations.grid(row=4, column=1)

#==================Right Side
lblPostCode = Label(InsideRF, font=('arial', 12, 'bold'), text="Post Code", fg="Forest green", bd=10, anchor="w")
lblPostCode.grid(row=0, column=0)
txtPostCode = Entry(InsideRF, font=('arial', 12, 'bold'), bd=10, width=50, bg="yellow green", justify="right", textvariable = PostCode)
txtPostCode.grid(row=0, column=1)

lblGender = Label(InsideRF, font=('arial', 12, 'bold'), text="Gender", fg="Forest green", bd=10, anchor="w")
lblGender.grid(row=1, column=0)
txtGender = Entry(InsideRF, font=('arial', 12, 'bold'), bd=10, width=50, bg="yellow green", justify="right", textvariable = Gender)
txtGender.grid(row=1, column=1)

#----------------------------
lblPayDate = Label(InsideRFL, font=('arial', 12, 'bold'), text="Pay Date", fg="Forest green", bd=10, anchor="w")
lblPayDate.grid(row=0, column=0)
txtPayDate = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="yellow green", justify="left", textvariable = PayDate)
txtPayDate.grid(row=0, column=1)

lblTaxPeriod = Label(InsideRFL, font=('arial', 12, 'bold'), text="Tax Period", fg="Forest green", bd=10, anchor="w")
lblTaxPeriod.grid(row=1, column=0)
txtTaxPeriod = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="yellow green", justify="left", textvariable = TaxPeriod)
txtTaxPeriod.grid(row=1, column=1)

lblNINumber = Label(InsideRFL, font=('arial', 12, 'bold'), text="NI Number", fg="Forest green", bd=10, anchor="w")
lblNINumber.grid(row=2, column=0)
txtNINumber = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="yellow green", justify="left", textvariable = NINumber)
txtNINumber.grid(row=2, column=1)

lblNICode = Label(InsideRFL, font=('arial', 12, 'bold'), text="NI Code", fg="Forest green", bd=10, anchor="w")
lblNICode.grid(row=3, column=0)
txtNICode = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="yellow green", justify="left", textvariable = NICode)
txtNICode.grid(row=3, column=1)

lblTaxablePay = Label(InsideRFL, font=('arial', 12, 'bold'), text="Taxable Pay ", fg="Forest green", bd=10, anchor="w")
lblTaxablePay .grid(row=4, column=0)
txtTaxablePay  = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="yellow green", justify="left", textvariable = TaxablePay)
txtTaxablePay .grid(row=4, column=1)

lblPensionablePay = Label(InsideRFL, font=('arial', 12, 'bold'), text="Pensionable Pay", fg="Forest green", bd=10, anchor="w")
lblPensionablePay.grid(row=5, column=0)
txtPensionablePay = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="yellow green", justify="left", textvariable = PensionablePay)
txtPensionablePay.grid(row=5, column=1)

lblOtherPaymentDue = Label(InsideRFL, font=('arial', 12, 'bold'), text="Other Payment Due", fg="Forest green", bd=10, anchor="w")
lblOtherPaymentDue.grid(row=6, column=0)
txtOtherPaymentDue = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="yellow green", justify="left", textvariable = OtherPaymentDue)
txtOtherPaymentDue.grid(row=6, column=1)

#----------------------
btnWagePayment = Button(InsideRFR, padx=8, pady=8, fg="black", font=('arial', 12, 'bold'), width=14,
                        text="Wage Paymant", bg="lime green", command=MonthlySalary).grid(row=0, column=0)

btnReset = Button(InsideRFR, padx=8, pady=8, fg="black", font=('arial', 12, 'bold'), width=14,
                        text="Reset System", bg="lime green", command=reset).grid(row=1, column=0)

btnPayRef = Button(InsideRFR, padx=8, pady=8, fg="black", font=('arial', 12, 'bold'), width=14,
                        text="Pay Reference", bg="lime green", command=PayRef).grid(row=2, column=0)

btnPayCode = Button(InsideRFR, padx=8, pady=8, fg="black", font=('arial', 12, 'bold'), width=14,
                        text="Pay Code", bg="lime green", command=PayPeriod).grid(row=3, column=0)

btnExit = Button(InsideRFR, padx=8, pady=8, fg="black", font=('arial', 12, 'bold'), width=14,
                        text="Exit", bg="lime green", command=exit).grid(row=4, column=0)
